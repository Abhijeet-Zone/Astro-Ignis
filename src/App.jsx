...
import MorseCodeModule from "./AllComponents/MorseCode/MorseCodeModule.jsx";
  ...
  return (
    <Router>
      <div className="flex">
        ...
        <div className="p-0 m-0 min-h-screen w-full">
          <Routes>
            ...
            <Route path="/morse" element={<MorseCodeModule />} />
          </Routes>
        </div>
      </div>
    </Router>
